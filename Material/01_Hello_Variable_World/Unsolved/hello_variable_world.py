...
# YOUR CODE HERE!
print(f"The original price of the stock:{original_price}. The current price of the stock: {current_price}.")
print(f"Change in stock price: {round(increase,2)}.")
print(f"Percentage change in stock price:{round(percent_increase,2)}%")